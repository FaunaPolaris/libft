...
SRC_STRING	+=	fp_strrchr.c fp_strmapi.c fp_strtrim.c fp_strndup.c fp_strlen.c fp_plen.c
...
test:
	@$(CC) $(CFLAGS) $(SRC_ALL) -o gnl_test tests/gnl_test.c -I./header
	@echo "$(YELLOW)gnl_test compiled$(SET_0)"
...
.PHONY: clean all test clean fclean re
